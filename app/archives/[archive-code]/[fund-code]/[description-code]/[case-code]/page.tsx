...
const CasePage: NextPage = () => {
  ...
  useEffect(() => {
    const fetchArchive = async () => {
      const response = await fetch(`/api/archives/${archiveCode}/${descriptionCode}/${code}`);
  ...
  return <Container>
    <Heading fontSize="xl">
      Ресурси де можна знайти справу {toText({ archive: archiveCode, fund: fundCode, description: descriptionCode, case: code })}
    </Heading>
    <UnorderedList>
