# ДААРК — mbv6.pdf, printed pages 10–267 (pdf offset +0)

```
ДААРК: summary fonds 1 ['142'] | blocks 511 | справи 6035 | refs w/o ф. 9 (dropped 0) | multi-fond blocks 58 | confessions ['ІСЛАМ', 'ІУДАЇЗМ', 'ВІРМЕНО-ГРИГОРІАНСТВО', 'ПРАВОСЛАВ’Я', 'ПРОТЕСТАНТИЗМ', 'РИМО-КАТОЛИЦИЗМ']
   refs by fond: [('142', 1336), ('321', 1076), ('299', 825), ('324', 752), ('293', 366), ('370', 294), ('319', 262), ('323', 172), ('320', 142), ('669', 101), ('265', 71), ('316', 60)]
   описи per fond: {'142': 8, '295': 1, '752': 1, '296': 2, '294': 2, '14': 1, '836': 1, '268': 1}
```
...
## Title patterns among catalog-referenced files that are not «Метрична книга. …» (1223)
- 787 × `<empty>`
- 94 × `Метрическая книга рождения, бракосочетания, смерти`
- 76 × `Метричні книги Православних церков`
- 55 × `Метрична книга про народження. Єврейська громада. `
- 43 × `Метрична книга про розлучення. Єврейська громада. `
- 22 × `Метрична книга про смерть. Єврейська громада. Кара`
- 21 × `Метрична книга про одруження. Єврейська громада. К`
- 19 × `Метрична книга про смерть. Єврейська громада. Сімф`
- 13 × `Метрична книга про одруження. Єврейська громада. Б`
- 11 × `Метрична книга про смерть. Єврейська громада. Бахч`
- 9 × `Метрична книга про одруження. Єврейська громада. С`
- 9 × `Метрична книга про одруження. Єврейська громада. Ф`

DB files in referenced fonds: 6618. Work dir: `work/mbv6-ДААРК/` (text, parsed json, DB snapshots, actions-ДААРК.json).
