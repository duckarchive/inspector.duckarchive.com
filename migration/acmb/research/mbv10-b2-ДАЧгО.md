# ДАЧгО — mbv10-b2.pdf, printed pages 6–1076 (pdf offset -8)

```
ДАЧгО: summary fonds 0 [] | blocks 1555 | справи 10034 | refs w/o ф. 0 (dropped 0) | multi-fond blocks 108 | confessions ['ПРАВОСЛАВ’Я']
   refs by fond: [('1462', 4995), ('679', 3853), ('1530', 1178), ('712', 2), ('6779', 2), ('Р67', 1), ('128', 1), ('69', 1), ('Р17', 1)]
   описи per fond: {'679': 17, '1462': 1, '1530': 6, '712': 1, '6779': 1, 'Р67': 1, '128': 1, '69': 1}
```
...
## Title patterns among catalog-referenced files that are not «Метрична книга. …» (8923)
- 5432 × `<empty>`
- 3463 × `Church records, Chernihiv N-N`
- 6 × `Метричні книги церков Конотопського повіту`
- 6 × `Сповідні книги церков Конотопського повіту`
- 1 × `Сповідні книги церков Остерського повіту`
- 1 × `Сповідні книги церков Козелецького повіту`
- 1 × `Метричні книги церков Козелецького повіту`
- 1 × `Метричні книги церков Роменського, Новгород-Сіверс`
- 1 × `Сповідні книги церков Конотопського, Борзнянського`
- 1 × `Сповідні книги церков Конотопського та Кролевецько`
- 1 × `Метрична книга Вознесенської церкви с. Томарівка П`
- 1 × `Сповідні книги церков Роменського повіту`

DB files in referenced fonds: 30582. Work dir: `work/mbv10-b2-ДАЧгО/` (text, parsed json, DB snapshots, actions-ДАЧгО.json).
