# ДАЖО — mbv9-b1.pdf, printed pages 11–690 (pdf offset +0)

```
ДАЖО: summary fonds 0 [] | blocks 1249 | справи 2171 | refs w/o ф. 23 (dropped 0) | multi-fond blocks 6 | confessions ['ПРАВОСЛАВ’Я']
   refs by fond: [('1', 2158), ('590', 5), ('579', 3), ('581', 2), ('584', 1), ('582', 1), ('583', 1)]
   описи per fond: {'1': 16, '581': 1, '584': 1, '582': 1, '579': 1, '590': 1, '583': 1}
```
...
## Title patterns among catalog-referenced files that are not «Метрична книга. …» (1899)
- 154 × `Метричні книги православних церков Житомирського п`
- 152 × `Метричні книги православних церков Кременецького п`
- 151 × `Метричні книги православні`
- 122 × `Метричні книги православних церков Володимирського`
- 116 × `Метричні книги православних церков Ковельського по`
- 113 × `Метричні книги православних церков Луцького повіту`
- 69 × `Метричні книги православних церков Заславського по`
- 66 × `Метричні книги православних церков`
- 50 × `Метричні книги про народження, шлюб, смерть по цер`
- 37 × `Метричні книги про народження, шлюб, смерть по сел`
- 36 × `Метричні книги православних церков Дубенського пов`
- 33 × `Метрична книга про народжених, про тих, хто взяв ш`

DB files in referenced fonds: 27266. Work dir: `work/mbv9-b1-ДАЖО/` (text, parsed json, DB snapshots, actions-ДАЖО.json).
