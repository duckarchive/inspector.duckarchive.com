# ДАЧгО — mbv10-b1.pdf, printed pages 19–648 (pdf offset +0)

```
ДАЧгО: summary fonds 0 [] | blocks 2282 | справи 887 | refs w/o ф. 0 (dropped 0) | multi-fond blocks 140 | confessions ['ПРАВОСЛАВ’Я']
   refs by fond: [('1462', 515), ('679', 331), ('712', 38), ('1530', 3)]
   описи per fond: {'679': 10, '1462': 1, '712': 1, '1530': 3}
```
...
## Title patterns among catalog-referenced files that are not «Метрична книга. …» (856)
- 448 × `<empty>`
- 368 × `Church records, Chernihiv N-N`
- 5 × `Метричні книги церков Конотопського повіту Новгоро`
- 4 × `Метричні книги церков Козелецького повіту`
- 3 × `Сповідні книги церков Ніжинської сотні Ніжинського`
- 3 × `Сповідні книги церков Роменського повіту`
- 2 × `Сповідні книги церков Козелецької сотні Київського`
- 2 × `Метричні книги Троїцької церкви с. Крехаїв Козелец`
- 2 × `Сповідні книги церков Конотопського повіту Новгоро`
- 2 × `Сповідні книги церков Конотопського повіту`
- 1 × `Сповідні книги церков Решетилівської протопопії Ки`
- 1 × `Сповідні книги церков Борзнянського, Роменського т`

DB files in referenced fonds: 30365. Work dir: `work/mbv10-b1-ДАЧгО/` (text, parsed json, DB snapshots, actions-ДАЧгО.json).
